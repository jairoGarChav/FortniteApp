...
<body>
    ...
    <script>
        ...
        var tipoEquipoDuos = document.getElementById('duos');
        var tipoEquipoTrios = document.getElementById('trios');
        var tipoEquipoEscuadrones = document.getElementById('escuadrones');
        var inputJugador3 = document.getElementById('jugador3');
        var inputMuertesJugador3 = document.getElementById('jugador3-muertes');
        var inputJugador4 = document.getElementById('jugador4');
        var inputMuertesJugador4 = document.getElementById('jugador4-muertes');

        tipoEquipoDuos.addEventListener('change', desactivarJugadores);
        tipoEquipoTrios.addEventListener('change', desactivarJugadores);
        tipoEquipoEscuadrones.addEventListener('change', desactivarJugadores);
        ...
        function desactivarJugadores() {
            ...
            } else if (tipoEquipoTrios.checked) {
                inputJugador4.disabled = true;
                inputMuertesJugador4.disabled = true;
            }
        }
